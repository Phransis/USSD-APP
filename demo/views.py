...
def index(request):
    if request.method == 'POST':
        ...
        if text == "":
            ...
            response += "1. Daily @ GHS10 \n"
            response += "2. Weekly @ GHS5 \n"
            response += "3. Monthly @ GHS2.5 "   

        elif text == "1*1":
            response = "CON You will be charged GHS10 for your Daily Sports news subscription \n"
            ...
            response = "CON You will be charged GHS5 for our weekly Sports news plan \n"
            response += "1. Auto-Renew \n"
            response += "2. One-off Purchase \n"
            ...
            response = "CON You will be charged GHS2.5 for our monthly Sports news plan \n"
            response += "1. Auto-Renew \n"
            response += "2. One-off Purchase \n"
